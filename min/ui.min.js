...
node.removeAttribute("ifNot");if(attrVal){var parent=node.parentNode;parent.removeChild(node);UI.bindState.proceed=false;}});UI.attribute("repeat",function(templateNode,_,collection){var templator=UI.bindState.templator;$L.assert(collection!==undefined,"Expected collection, got undefined")
