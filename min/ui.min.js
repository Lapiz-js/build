...
if($L.typeCheck.func(collection.on.remove)){delFn=function(key,accessor,oldObj){var n=index[key];delete index[key];n.parentNode.removeChild(n);};collection.on.remove(delFn);Lapiz.UI.on.remove(parent,function(){collection.on.insert.deregister(delFn);});}
