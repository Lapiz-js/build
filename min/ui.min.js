...
return node;}
function _getFormValues(form){var nameQuery=form.querySelectorAll("[name]");var i,n,nodeType,parse;var data=$L.Map();for(i=nameQuery.length-1;i>=0;i-=1){n=nameQuery[i];nodeType=n.type;if(nodeType==="checkbox"||nodeType==="radio"){data[n.name]=n.checked;}else{parse=n.getAttribute("parse");if(parse!=null){data[n.name]=$L.parse(parse)(n.value);}else{data[n.name]=n.value;}}}
return data;}
